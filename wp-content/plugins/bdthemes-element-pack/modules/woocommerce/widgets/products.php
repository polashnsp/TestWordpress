...
class Products extends Module_Base {
	...
	public function get_style_depends() {
        if ($this->ep_is_edit_mode()) {
            ...
            return [ 'ep-woocommerce','datatables-uikit', 'element-pack-font' ];
        }
    }
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'25'   => esc_html__( '25', 'bdthemes-element-pack' ),
					'50' => esc_html__( '50', 'bdthemes-element-pack' ),
					'100' => esc_html__( '100', 'bdthemes-element-pack' ),
				],
				'condition' => [
					'show_pagination' => 'yes'
				]
